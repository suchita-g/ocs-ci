...
class AZURE:
    ...
    def restart_vms_by_stop_and_start(self, node_names, timeout=540, wait=True):
        """
        restart an Azure vm instance by stop and start
        ...
        """
        self.stop_vm_instance(node_names, timeout=timeout, wait=wait)
        self.start_vm_instance(node_names, timeout=timeout, wait=wait)
